    ...
    <div>
      <div class="flex flex-col-reverse text-center lg:text-left">
        ...
        <div class="my-2 flex items-center justify-center gap-2 lg:hidden">
          <div class="skeleton-effect h-6 w-4/12 rounded bg-gray-300 pr-2 font-semibold dark:bg-zinc-800"></div>
          <div class="skeleton-effect h-6 w-4/12 rounded bg-gray-300 pr-2 font-semibold dark:bg-zinc-800"></div>
          <div class="skeleton-effect h-6 w-4/12 rounded bg-gray-300 pr-2 font-semibold dark:bg-zinc-800"></div>
        </div>
        <!-- Desktop -->
        <div class="flex items-center justify-center gap-2 text-xs sm:text-sm lg:mb-2 lg:justify-start lg:text-lg">
          <div class="skeleton-effect h-4 w-1/12 rounded bg-gray-300 pr-2 font-semibold dark:bg-zinc-800"></div>
          <div class="skeleton-effect h-4 w-1/4 rounded bg-gray-300 pr-2 font-semibold dark:bg-zinc-800"></div>
          <div class="skeleton-effect h-4 w-2/12 rounded bg-gray-300 pr-2 font-semibold dark:bg-zinc-800"></div>
          <div class="skeleton-effect hidden h-6 w-1/12 rounded bg-gray-300 pr-2 font-semibold dark:bg-zinc-800 lg:block">
          </div>
          <div class="skeleton-effect hidden h-6 w-1/12 rounded bg-gray-300 pr-2 font-semibold dark:bg-zinc-800 lg:block">
          </div>
          <div class="skeleton-effect hidden h-6 w-1/12 rounded bg-gray-300 pr-2 font-semibold dark:bg-zinc-800 lg:block">
      ...
      <div class="mt-2.5 flex flex-col items-center gap-2 lg:items-start">
        <div class="skeleton-effect h-4 w-11/12 rounded-full bg-gray-300 dark:bg-zinc-800"></div>
        <div class="skeleton-effect h-4 w-10/12 rounded-full bg-gray-300 dark:bg-zinc-800"></div>
        <div class="skeleton-effect h-4 w-11/12 rounded-full bg-gray-300 dark:bg-zinc-800"></div>
        <div class="skeleton-effect h-4 w-9/12 rounded-full bg-gray-300 dark:bg-zinc-800"></div>
        <div class="skeleton-effect h-4 w-10/12 rounded-full bg-gray-300 dark:bg-zinc-800"></div>
        <div class="skeleton-effect h-4 w-6/12 rounded-full bg-gray-300 dark:bg-zinc-800"></div>
      </div>
    </div>
  </div>
  <div v-else-if="data && !loading">
    <div class="flex flex-col-reverse text-center lg:text-left">
      <h1 class="inline-block flex-shrink-0 font-semibold leading-8 lg:leading-none" :class="{
      ...
      <!-- Mobile Extensions -->
      <div class="my-2 flex items-center justify-center gap-2 lg:hidden">
        <h2 v-if="contentRating && contentRating !== 'Not Rated'" class="line-clamp-1 border px-2 text-lg font-semibold"
          :class="{
        ...
        <IMDBLink v-if="data?.imdb_id" :imdb="data?.imdb_id" :score="imdbScore" />
        <RottenTomatoes v-if="rottenTomatoesScore" :score="rottenTomatoesScore" />
      </div>
      <!-- Desktop -->
      <div class="flex items-center justify-center divide-x-2 text-xs sm:text-sm lg:justify-start lg:text-lg" :class="{
    ...
    <p class="mt-2 line-clamp-6 text-center text-base lg:text-left lg:text-xl" :class="{
